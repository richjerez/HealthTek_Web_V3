    ...
    public partial class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                emailModel.FromEmail = Input.NewEmail;
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            Messages emailModel = new Messages();
            emailModel.FromEmail = email;
            emailModel.Title = "Confirm your email";
            emailModel.Message = $"<img src='https://i.ibb.co/PWd0zVT/undraw-unexpected-friends-tg6k.png' alt='Neo-DevOps-App Confirm Email' style='width: 300px;margin: auto;display: block; '/> Thank you for being with us! Please confirm your email by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.";
            _emailSender.SendMessage(emailModel);
